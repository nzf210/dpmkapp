...
function MyModal({ setgetUserInfo }) {
...
function MyModalInfo({ datahasil }) {
    let [isOpen, setIsOpen] = useState(false)
    function closeModal() { setIsOpen(false) }
    function openModal() { setIsOpen(true) }
...
function MyModalEdit({ idEdit, editData, setIdEdit_ }) {
...
function MyModalHapus({ hapusdataid, idhapus, setgetInfoEdit }) {
    const navLink = useNavigate();
    let [isOpen, setIsOpen] = useState(false)
    function closeModal() { setIsOpen(false) }
    function openModal() { setIsOpen(true) }
