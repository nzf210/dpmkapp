...
const LaporanSp2d = () => {
    ...
    const [columnDefs] = useState([
        ...
        { field: 'thp_1', headerName: 'Tahap I', width: 120, filter: true, suppressSizeToFit: true, cellRenderer: (e) => (e.data.thp_1 === null ? <span className='bg-red-400 px-2 rounded-sm text-red-300'>Proses.....</span> : <span >{e.value}</span>) },
        { field: 'thp_2', headerName: 'Tahap II', width: 120, filter: true, suppressSizeToFit: true, cellRenderer: (e) => (e.data.thp_2 === null ? <span className='bg-red-400 px-2 rounded-sm text-red-300'>Proses.....</span> : <span >{e.value}</span>) },
    ...
    useEffect(() => {
        ...
        async function geT() {
            setLoad(true);
            let url = `/laporan?page=${page}&size=${perpage}`;
            ...
            <div className='grid grid-flow-row h-0'>
                ...
                <div >
                    ...
                    <div className="flex flex-row items-center justify-center z-10">
                        <span className='font-semibold mr-4'>Laporan SP2D Gabungan</span>
                    ...
                    <div className='container w-full bg-slate-400 mx-auto -z-40 relative'>
                        <div className='mx-auto'>
                            ...
                            <div className='mx-auto my-auto relative'>
                                <div className="ag-theme-alpine items-center mx-auto absolute" style={{ width: '100%', height: 615, }}>
                                    <AgGridReact
