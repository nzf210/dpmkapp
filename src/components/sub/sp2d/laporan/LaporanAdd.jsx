...
const LaporanSp2dReg = () => {
    ...
    const [columnDefs] = useState([
        ...
        { field: 'pagu_thp4', headerName: 'Tahap IV', width: 120, filter: true, suppressSizeToFit: true, cellRenderer: (e) => (e.data.pagu_thp4 === null ? <span className='bg-red-400 px-2 rounded-sm text-red-300'>Proses.....</span> : <CurrencyFormat value={e.value} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} />) },
    ...
    useEffect(() => {
        ...
        async function geT() {
            setLoad(true);
            let url = `/laporan/add?page=${page}&size=${perpage}`;
            ...
            <div className='grid grid-flow-row h-0'>
                ...
                <div >
                    ...
                    <div className="flex flex-row items-center justify-center z-10">
                        <span className='font-semibold mr-4'>Laporan SP2D ADD</span>
