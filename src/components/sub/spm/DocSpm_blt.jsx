...
const SpmDoc_blt = ({ dataselectspp }) => {
    // useEffect(() => {
                            ...
                            <View style={{ fontSize: 11, }}>
                                <View style={{ marginTop: 2 }}>
                                    <Text>Kami yang bertandatangan dibawah ini Adalah Benar Kepala Kampung dan Bendahara yang berhak Mencairkan Dana
                                        Desa (DD) berupa Bantuan Langsung Tunai (BLT) {e.thp_select} Tahun 2022 :</Text>
                                </View>
                                <View style={{ marginTop: 2 }}>
                                    ...
                                    <View style={{ flexDirection: 'column', lineHeight: 1.1, marginTop: 14 }}>
                                        ...
                                        <View>
                                            ...
                                            <Text>
                                                ...
                                                setelah menerima Dana Desa (DD)
                                                berupa Bantuan Langsung Tunai (BLT) {e.thp_select} Tahun 2022 akan melaksanakan
                                ...
                                <View style={{
                                    ...
                                    <View style={{ width: "20%", flexDirection: 'column', height: '100%' }}>
                                        ...
                                        <View style={{ border: '1px', borderColor: 'black', borderStyle: 'dashed', height: '100%' }}>
                                            <Text style={{ textAlign: 'center', alignItems: 'center', paddingTop: 15 }}>Dana Desa {e.opt3}</Text>
                                        </View>
