...
const SpmDoc_cov = ({ dataselectspp }) => {
    // useEffect(() => {
                            ...
                            <View style={{ fontSize: 11, }}>
                                <View style={{ marginTop: 2 }}>
                                    <Text>Kami yang bertandatangan dibawah ini Adalah Benar Kepala Kampung dan Bendahara yang berhak Mencairkan Dana
                                        Desa (DD) berupa Bantuan Penanganan Covid-19 Tahun 2022 :</Text>
                                </View>
                                <View style={{ marginTop: 2 }}>
                                    ...
                                    <View style={{ flexDirection: 'column', lineHeight: 1.1, marginTop: 14 }}>
                                        ...
                                        <View>
                                            ...
                                            <Text>
                                                ...
                                                berupa Bantuan Penanganan Covid-19 Tahun 2022 akan melaksanakan ketentuan sebagai berikut :
                                            </Text>
                            ...
                            <View style={{ fontSize: 11, flexDirection: 'column' }}>
                                ...
                                <View style={{
                                    ...
                                    <View style={{ width: "20%", flexDirection: 'column', height: '100%' }}>
                                        ...
                                        <Text style={{ textAlign: 'center', border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'center', height: '100%', paddingTop: 20 }}>
                                            <CurrencyFormat value={e.pagu} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} />
                                        </Text>
