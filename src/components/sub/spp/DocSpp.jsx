                            ...
                            <View style={{ fontSize: 12 }}>
                                ...
                                <View style={{ marginTop: -10 }}>
                                    <View style={{ width: 260, alignSelf: 'flex-end' }}>
                                        ...
                                        <Text style={{ textAlign: 'center', fontWeight: 'bold', marginTop: 50, fontSize: 13, textDecoration: 'underline' }}>{e.nama}</Text>
                                    </View>
                                </View>
                            </View>
                            <Text
                        ...
                        <Page size="A4" orientation="landscape"
                            ...
                            <View style={{ fontSize: 12 }}>
                                ...
                                <View style={{ marginTop: -31 }}>
                                    ...
                                    <Text style={{ paddingTop: -16, paddingLeft: 130, width: 2, maxWidth: 2 }}>:</Text>
                                    <Text style={{ paddingTop: -31, paddingLeft: 135, }}>Triwulan I</Text>
                                </View>
                                <View style={{ marginTop: -31 }}>
                                    ...
                                    <View >
                                        <View >
                                            ...
                                            <View style={{ textAlign: 'center', border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start' }}>
                                                ...
                                                <Text style={{ width: 120, textAlign: 'right', marginTop: 2, fontWeight: 'semibold' }}>Rp 33.600.000,-</Text>
                                            </View>
                                        </View>
                                    </View>
                                    <View >
