                                    ...
                                    <View >
                                        <View >
                                            ...
                                            <View style={{ textAlign: 'center', border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start' }}>
                                                ...
                                                <Text style={{ color: 'white' }}>0</Text>
                                                <Text style={{ textAlign: 'right', width: 83, fontWeight: 'semibold' }}><CurrencyFormat value={parseInt(e.tot_blt)} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} />
                                                </Text>
                                                {/* <Text style={{ color: 'white' }}>0</Text>
                                    ...
                                    <View >
                                        <View >
                                            ...
                                            <View style={{ textAlign: 'center', border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start' }}>
                                                ...
                                                <Text style={{ color: 'white' }}>-</Text>
                                                <Text style={{ textAlign: 'center', alignItems: 'center', width: 150, alignContent: 'center', paddingLeft: 20 }}><CurrencyFormat value={parseInt(e.tot_blt - (e.pagu + e.blt_spp_cair))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                <Text style={{ color: 'white' }}>-</Text>
                                                <Text style={{ textAlign: 'center', alignItems: 'center', width: 150, paddingLeft: 20, fontWeight: 'semibold' }}><CurrencyFormat value={parseInt(e.tot_blt - (e.pagu + e.blt_spp_cair))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                {/* <Text style={{ color: 'white' }}>-</Text>
