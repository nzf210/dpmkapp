...
const DocSpp_blt = ({ dataselectspp }) => {
                        ...
                        >
                            ...
                            <View style={{ fontSize: 11, flexDirection: 'column', marginLeft: 30, marginTop: -55 }}>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <Text style={{ width: 2 }}>:</Text>
                                    <Text style={{ paddingLeft: 10, width: 250 }}>{e.tahap}</Text>
                                </View>
                                <View style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ paddingLeft: 20 }}>
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text>a. </Text>
                                        <Text style={{ width: 170 }} >Jumlah Pagu Bantuan</Text>
                                        <Text style={{ width: 2 }}>:</Text>
                                        <Text style={{ paddingLeft: 10 }}><CurrencyFormat value={e.tot_blt} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                    </View>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        ...
                                        <Text style={{ paddingLeft: 10 }}>
                                            <CurrencyFormat value={parseInt(e.tot_blt - (e.pagu + e.blt_spp_cair))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} />
                                        </Text>
                                    </View>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        ...
                                        <Text style={{ width: 2 }}>:</Text>
                                        <Text style={{ paddingLeft: 10 }}><CurrencyFormat value={parseInt(e.tot_blt - (parseInt(e.tot_blt) - (parseInt(e.pagu) + parseInt(e.blt_spp_cair))))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                    </View>
                                    <Text><Text style={{ color: 'white', marginTop: -4, paddingTop: -4 }}>...</Text>.........................................................................................................</Text>
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text>d. </Text>
                                    ...
                                    <View style={{ flexDirection: 'row' }}>
                                        <Text>e. </Text>
                                        <Text style={{ width: 170 }}  >Sisa Jumlah Dana yang belum di Cairkan </Text>
                                        <Text style={{ width: 2 }}>:</Text>
                                        <Text style={{ paddingLeft: 10 }}><CurrencyFormat value={parseInt(e.tot_blt - (parseInt(e.tot_blt) - (parseInt(e.pagu) + parseInt(e.blt_spp_cair))))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                    </View>
                                    <Text><Text style={{ color: 'white', marginTop: -4, paddingTop: -4 }}>...</Text>.........................................................................................................</Text>
                                    ...
                                    <View style={{ height: '100%' }}>
                                        <View >
                                            ...
                                            <View style={{ border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start', paddingHorizontal: 4 }} >
                                                ...
                                                <Text style={{ color: 'white' }}>0</Text>
                                                <Text >
                                                    <CurrencyFormat value={parseInt(e.tot_blt)} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} />
                                                </Text>
                                                <Text style={{ color: 'white' }}>0</Text>
                                                <Text style={{ fontWeight: 'semibold' }}><CurrencyFormat value={parseInt(e.tot_blt)} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} />
                                                </Text>
                                                {/* <Text style={{ color: 'white' }}>0</Text>
                                    ...
                                    <View style={{ height: '100%' }}>
                                        <View >
                                            ...
                                            <View style={{ border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start', flexDirection: 'column' }}>
                                                ...
                                                <Text style={{ color: 'white' }}>-</Text>
                                                <Text style={{ textAlign: 'center', marginLeft: 50 }}><CurrencyFormat value={parseInt(e.tot_blt - (e.pagu + e.blt_spp_cair))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                <Text style={{ color: 'white' }}>-</Text>
                                                <Text style={{ fontWeight: 'semibold', textAlign: 'center', marginLeft: 50 }}><CurrencyFormat value={parseInt(e.tot_blt - (e.pagu + e.blt_spp_cair))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                {/* <Text style={{ color: 'white' }}>-</Text>
                                    ...
                                    <View style={{ height: '100%' }}>
                                        <View style={{ width: 101, }}>
                                            ...
                                            <View style={{ border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start' }}>
                                                {/* <Text style={{ color: 'white' }}>0</Text> */}
                                                <Text style={{ color: 'white' }}>0</Text>
                                                <Text style={{ width: 100, textAlign: 'center' }}><CurrencyFormat value={parseInt(e.blt_spp_cair)} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                <Text style={{ color: 'white' }}>0</Text>
                                                <Text style={{ width: 100, fontWeight: 'semibold', textAlign: 'center' }}><CurrencyFormat value={parseInt(e.blt_spp_cair)} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                {/* <Text style={{ color: 'white' }}>0</Text>
