                                ...
                                <View style={{
                                    ...
                                    <View style={{ width: "35%" }}>
                                        ...
                                        <View style={{ border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start' }}>
                                            <Text style={{ fontWeight: 'semibold' }} ><Text style={{ color: 'white' }}>....</Text>5.......... Kegiatan Reguler {e.opt1}</Text>
                                            <Text><Text style={{ color: 'white' }}>....</Text>- Kegiatan Reguler {e.opt1}</Text>
                                    ...
                                    <View >
                                        <View >
                                            ...
                                            <View style={{ textAlign: 'center', border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start' }}>
                                                ...
                                                <Text style={{ color: 'white' }}>0</Text>
                                                <Text style={{ textAlign: 'right', width: 83, fontWeight: 'semibold' }}><CurrencyFormat value={parseInt(e.tot_reg)} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} />
                                                </Text>
                                                {/* <Text style={{ color: 'white' }}>0</Text>
                                    ...
                                    <View >
                                        <View >
                                            ...
                                            <View style={{ textAlign: 'center', border: '1px', borderColor: 'black', borderStyle: 'dashed', paddingVertical: 3, alignItems: 'flex-start' }}>
                                                ...
                                                <Text style={{ color: 'white' }}>-</Text>
                                                <Text style={{ textAlign: 'center', alignItems: 'center', width: 150, alignContent: 'center', paddingLeft: 20 }}><CurrencyFormat value={parseInt(e.tot_reg - (e.pagu + e.reg_spp_cair))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                <Text style={{ color: 'white' }}>-</Text>
                                                <Text style={{ textAlign: 'center', alignItems: 'center', width: 150, paddingLeft: 20, fontWeight: 'semibold' }}><CurrencyFormat value={parseInt(e.tot_reg - (e.pagu + e.reg_spp_cair))} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} /></Text>
                                                {/* <Text style={{ color: 'white' }}>-</Text>
