...
const SppAdd = () => {
    ...
    {
        field: 'tgl', title: 'Tgl SPD', type: "date", dateSetting: { locale: "id-ID" }
    ...
    {
        field: 'sts', title: 'Status', editable: () => false, render: (row) => row.sts ? <div className='bg-yellow-200 rounded-md p-2 text-center -translate-x-3'>Proses SPD</div> : null, align: 'center'
    },
    ]
    const kolom_ = [{
        field: 'thp_advis', title: 'Kegiatan'
    ...
    {
        field: 'tgl', title: 'Tgl SPP', type: "date", dateSetting: { locale: "id-ID" }
    ...
    {
        field: 'sts', title: 'Status', editable: () => false, render: (row) => <div className='bg-gren-400 rounded-md p-2 text-center -translate-x-3'>SPP Siap Cetak</div>, align: 'center'
    },
    ]
