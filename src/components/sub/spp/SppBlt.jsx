...
import DocSpp_blt from './DocSpp_blt';
    ...
    const updateDataChecklist = async () => {
        ...
        try {
            dataprint_.map(async (f, i) => {
                ...
                switch (true) {
                    case (nodok < 10):
                        nomor = `000${nodok}/SP2SPD/DDBLT-${thp}/${f.kampung}/2022`;
                        console.log('<9', nomor);
                        break;
                    case (9 < nodok < 100):
                        nomor = `00${nodok}/SP2SPD/DDBLT-${thp}/${f.kampung}/2022`;
                        console.log('>9', nomor);
                        break;
                    case (99 > nodok > 1000):
                        nomor = `0${nodok}/SP2SPD/DDBLT-${thp}/${f.kampung}/2022`;
                        console.log('>99');
                        break;
                    case (999 > nodok > 9999):
                        nomor = `${nodok}/SP2SPD/DDBLT-${thp}/${f.kampung}/2022`;
                        console.log('>999');
                        break;
                    default:
                        break;
                ...
                <div className='fixed  mt-10 w-full z-50 flex'>
                    ...
                    <div className='grow'>
                        <div className='mx-auto justify-center items-center h-screen w-[90%]'>
                            ...
                            ><DocSpp_blt dataselectspp={dataVprint} /></PDFViewer>
            ...
            <div className='grid grid-flow-row h-0'>
                ...
                <div >
                    ...
                    <div className="flex items-center justify-center z-10">
                        ...
                        {print ? <div>
                            {viewbtn ?
                                <><PDFDownloadLink placeholder='Print Data PDF' document={<DocSpp_blt dataselectspp={dataDlprint} />} fileName={`doc_spp-reg_${new Date().toLocaleTimeString().slice(0, 16)}`}>
